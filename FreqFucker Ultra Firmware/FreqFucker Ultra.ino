...
void about() {
  ...
  u8g2.drawStr(15, 15, "C1PH3R-FSOCITEY");
  u8g2.drawStr(0, 35, "GitHub c1ph3r-fsocitey");
  u8g2.drawStr(0, 55, "Insta c1ph3r.fsocitey");
  u8g2.sendBuffer();
}
...
void setup() {
  ...
  u8g2.print("FreqFucker");
  u8g2.setCursor(35, 35); 
  u8g2.print("Ultra");
  u8g2.setFont(u8g2_font_ncenB08_tr); 
  u8g2.setCursor(5, 55); 
  u8g2.print("C1PH3R-FSOCITEY");
