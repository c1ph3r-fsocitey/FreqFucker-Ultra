...
switch (deviceType) {
  case 1:
    oAdvertisementData.setManufacturerData(String((char *)dataAirpods).substring(0, 31));
    break;
  case 2:
    oAdvertisementData.setManufacturerData(String((char *)dataAirpodsPro).substring(0, 31));
    break;
  case 3:
    oAdvertisementData.setManufacturerData(String((char *)dataAirpodsMax).substring(0, 31));
    break;
  case 4:
    oAdvertisementData.setManufacturerData(String((char *)dataAirpodsGen2).substring(0, 31));
    break;
  case 5:
    oAdvertisementData.setManufacturerData(String((char *)dataAirpodsGen3).substring(0, 31));
    break;
  case 6:
    oAdvertisementData.setManufacturerData(String((char *)dataAirpodsProGen2).substring(0, 31));
    break;
  case 7:
    oAdvertisementData.setManufacturerData(String((char *)dataPowerBeats).substring(0, 31));
    break;
  case 8:
    oAdvertisementData.setManufacturerData(String((char *)dataPowerBeatsPro).substring(0, 31));
    break;
  case 9:
    oAdvertisementData.setManufacturerData(String((char *)dataBeatsSoloPro).substring(0, 31));
    break;
  case 10:
    oAdvertisementData.setManufacturerData(String((char *)dataBeatsStudioBuds).substring(0, 31));
    break;
  case 11:
    oAdvertisementData.setManufacturerData(String((char *)dataBeatsFlex).substring(0, 31));
    break;
  case 12:
    oAdvertisementData.setManufacturerData(String((char *)dataBeatsX).substring(0, 31));
    break;
  case 13:
    oAdvertisementData.setManufacturerData(String((char *)dataBeatsSolo3).substring(0, 31));
    break;
  case 14:
    oAdvertisementData.setManufacturerData(String((char *)dataBeatsStudio3).substring(0, 31));
    break;
  case 15:
    oAdvertisementData.setManufacturerData(String((char *)dataBeatsStudioPro).substring(0, 31));
    break;
  case 16:
    oAdvertisementData.setManufacturerData(String((char *)dataBeatsFitPro).substring(0, 31));
    break;
  case 17:
    oAdvertisementData.setManufacturerData(String((char *)dataBeatsStudioBudsPlus).substring(0, 31));
    break;
  case 18:
    oAdvertisementData.setManufacturerData(String((char *)dataAppleTVSetup).substring(0, 31));
    break;
  case 19:
    oAdvertisementData.setManufacturerData(String((char *)dataAppleTVPair).substring(0, 31));
    break;
  case 20:
    oAdvertisementData.setManufacturerData(String((char *)dataAppleTVNewUser).substring(0, 31));
    break;
  case 21:
    oAdvertisementData.setManufacturerData(String((char *)dataAppleTVAppleIDSetup).substring(0, 31));
    break;
  case 22:
    oAdvertisementData.setManufacturerData(String((char *)dataAppleTVWirelessAudioSync).substring(0, 31));
    break;
  case 23:
    oAdvertisementData.setManufacturerData(String((char *)dataAppleTVHomekitSetup).substring(0, 31));
    break;
  case 24:
    oAdvertisementData.setManufacturerData(String((char *)dataAppleTVKeyboard).substring(0, 31));
    break;
  case 25:
    oAdvertisementData.setManufacturerData(String((char *)dataAppleTVConnectingToNetwork).substring(0, 31));
    break;
  case 26:
    oAdvertisementData.setManufacturerData(String((char *)dataTVColorBalance).substring(0, 31));
    break;
  default:
    oAdvertisementData.setManufacturerData(String((char *)dataAirpods).substring(0, 31)); 
    break;
